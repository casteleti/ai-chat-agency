...
3. Run integrity: migration ledger, table counts, FK/constraint checks, newest critical records, outbox/job consistency, vector/FTS indexes.
4. Reconcile R2 object metadata/checksums and deletion tombstones.
5. Point a quarantined app version to restored DB; run read-only smoke and security canaries.
