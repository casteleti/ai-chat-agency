...
| G2 | DB/outbox/jobs | G1 | database/events/worker | migration/idempotency | migration ledger/query plans |
| G3 | session/auth/consent/authz | G2 | identity/security/API | auth/security/matrix | zero unauthorized access |
